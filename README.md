<p align="center">
  ...
  <a href="https://github.com/JMC2002/SlayTheSpire2_BaseLibCrashGuard/releases"><img alt="Releases" src=".github/badges/releases.svg"></a>
<!-- code-stats:start -->
<!-- code-stats:end -->
</p>
...
其他版本可以自行编译，或者在[📦 Releases](https://github.com/JMC2002/SlayTheSpire2_BaseLibCrashGuard/releases)界面下载.zip后解压到游戏安装目录下的Mods
目录下（没有就新建一个）
...
-- Slay the Spire 2
    |-- SlayTheSpire2.exe
        |-- mods
             |-- JmcModLib
             |-- BaseLibCrashGuard
                  |-- BaseLibCrashGuard.dll
                  |-- BaseLibCrashGuard.pck
                  |-- BaseLibCrashGuard.json
```
